/* Clay configuration schema. messageKey values prefixed SET_ are forwarded to
 * the watch; the rest are read by the JS side only. Keep defaults in sync with
 * src/c/wsr88d.h and getConfig() in index.js. */
module.exports = [
  ...
  { "type": "section", "items": [
    { "type": "heading", "defaultValue": "Radar" },
